...
void preload(char* script) { g_params.preload_script = std::wstring(convert_wstring(script)); }
...
void evaluate(char* script, MessageListener callback)
{
    if (!g_webview) return;
    g_webview->ExecuteScript(convert_wstring(script).c_str(),
                ...
                HRESULT hr2 = g_env3->CreateCoreWebView2CompositionController(
                    ...
                    Callback<ICoreWebView2CreateCoreWebView2CompositionControllerCompletedHandler>(
                        [hwnd](HRESULT hr, ICoreWebView2CompositionController* controller) -> HRESULT
                        {
                            ...
                            if (!g_params.preload_script.empty())
                                g_webview->AddScriptToExecuteOnDocumentCreated(g_params.preload_script.c_str(), nullptr);
